      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-sm w-full">
          <div className="text-center mb-6">
            <img src="/icons/logo.svg" alt="LocationLens" className="w-12 h-12 mx-auto mb-2" />
            <h1 className="text-2xl font-bold text-gray-800">Admin Panel</h1>
            <p className="text-gray-500 text-sm mt-1">LocationLens Administration</p>
          </div>
        ...
        {stats && (
          <div className="grid grid-cols-4 gap-3 mb-6">
            ...
            <div className="bg-blue-50 rounded-xl p-4 text-center border border-blue-200">
              ...
              <p className="text-sm text-blue-700 mt-1">Users</p>
            </div>
          </div>
        )}
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          by {loc.user.name || `Photographer #${loc.user.id}`}
                        </p>
